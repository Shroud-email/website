  ...
  <Popover as="header" class="relative">
    ...
    <transition enter-active-class="duration-150 ease-out" enter-from-class="opacity-0 scale-95"
      ...
      <PopoverPanel focus class="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top md:hidden">
        <div class="rounded-lg shadow-md bg-white ring-1 ring-black/5 overflow-hidden">
          ...
          <div class="pt-5 pb-6">
            ...
            <div class="mt-6 px-5">
              <a href="https://app.shroud.email/users/log_in"
                class="block text-center w-full py-3 px-4 rounded-md shadow bg-indigo-600 text-white font-medium hover:bg-indigo-700">Log
                in</a>
            </div>
          </div>
        </div>
