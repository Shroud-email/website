...
const props = defineProps({
  tableOfContents: Object as PropType<Heading[]>,
})
...
<template>
  <div class="hidden xl:sticky xl:top-[4.5rem] xl:-mr-6 xl:block xl:h-[calc(100vh-4.5rem-8rem)] xl:flex-none xl:overflow-y-auto xl:py-16 xl:pr-6">
