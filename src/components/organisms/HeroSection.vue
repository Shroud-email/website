...
const initializeVanta = () => {
  // Keep trying to init vanta -- in case the vanta
  // script takes a bit of time to load
...
<template>
  <div
    id="hero"
    class="bg-gray-800 pb-8 sm:pb-12 lg:pb-12 flex items-center min-h-screen"
  >
      ...
      >
        <div>
          ...
          >
            ...
            <span class="italic">de facto</span> ID on the web. Protect it with
            unlimited, disposable aliases that remove trackers and forward to
