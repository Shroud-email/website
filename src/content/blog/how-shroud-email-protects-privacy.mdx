...
date: 2022-04-11
image: ../../assets/blog/surveillance-cameras.jpg
imageAlt: surveillance cameras covering a wall
---

import { Image } from "astro:assets";
import emailReport from "../../assets/blog/email-report.png";
...
<Image
  src={emailReport}
  alt="The Shroud.email privacy report showing one blocked tracker in an email"
  class="max-w-full sm:max-w-[80%] mx-auto"
  layout="constrained"
  width={672}
  widths={[320, 480, 538, 672]}
  sizes="(min-width: 672px) 538px, calc(100vw - 2rem)"
  loading="lazy"
  decoding="async"
/>
